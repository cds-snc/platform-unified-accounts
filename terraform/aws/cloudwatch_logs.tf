...
module "cloudwatch_log_storage" {
  source = "github.com/cds-snc/terraform-modules//cloudwatch_log_storage?ref=v11.4.5"
  ...
  cloudwatch_log_group_names = [
    ...
    module.idp_cleanup_users.cloudwatch_log_group_name,
    module.idp_event_exporter.cloudwatch_log_group_name
  ]
